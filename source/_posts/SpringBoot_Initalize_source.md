---
title: "SpringBoot初始化阅读"
date: 2021-02-23 12:00:00
updated: 2025-12-31 13:07:26
permalink: article/SpringBoot_Initalize_source/
categories:
  - "SpringBoot"
tags:
  - "SpringBoot"
  - "源码分析"
description: "SpringBoot扩展方法源码阅读"
---
...
可以看到该 Initializer 就是对 [spring.application.name](http://spring.application.name/) 进行获取,获取不到的话,就使用application默认值给设置到context中, 同时将 ContextId 也给注册到 beanFactory中去.
